...
module.exports = {
  ...
  botname: process.env.BOT_NAME || '😙💙Tiky boy 💘💑',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94719259989',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/ad25b2227fa2a1a01b707.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY 💑💙Tiky boy...💕🥺* 🎊',
  ownername:process.env.OWNER_NAME || '💕🎀Tiky boy 💙',
  ...
  LANG: process.env.THEME|| '🎀💙Tiky boy 🙃🖤',
